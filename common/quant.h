...
typedef struct
{
    int (*quant_8x8)( dctcoef dct[64], udctcoef mf[64], udctcoef bias[64], int unquant[64] );
    int (*quant_4x4)( dctcoef fenc_dct[16], dctcoef dct[16], udctcoef mf[16], udctcoef bias[16], int unquant[16] );
